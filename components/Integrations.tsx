    ...
    <section id="integrations" className="band" ref={ref}>
      <div className="wrap">
        <div className="section-head center">
          <span className="section-eyebrow">Formats</span>
          <h2>
            Works with <span style={{ color: "var(--green)" }}>every export</span>
          </h2>
          <p>Standard formats from the clients you already use. Drop a whole folder at once.</p>
        </div>
